...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'extracted_pp_dir': os.path.join(path, 'zh/sg_allverb_negatives.txt'),
        'pattern_set_path': os.path.join(path, 'zh/sg_dual_pattern_set.txt'),
        'neg_counter': os.path.join(path, 'zh/sg_wp_dual_counter.txt'),
        'pos_wp_path': os.path.join(path, 'zh/sg_sorted_pos_wp.txt'),
        'test_path': os.path.join(path, 'zh/bk_eva.txt'),
        'saved_path': os.path.join(path, 'zh/models/pattern/'),
