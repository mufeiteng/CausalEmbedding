...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'resource_path': os.path.join(path, 'en/wp_sim_use_wordnet_without_weight.txt'),  # 单词的近义词,无权重,使用wordnet计算
        # 词向量保存路径
        'cause_path': os.path.join(path, 'en/embed/mmplus_cause_v1'),
        'effect_path': os.path.join(path, 'en/embed/mmplus_effect_v1'),
